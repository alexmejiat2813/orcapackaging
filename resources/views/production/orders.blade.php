        ...
        $(document).ready(function () {
            ...
            $("#commandesGrid").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Order Code', datafield: 'InInvoiceNumber', width: 100 },
                    { text: 'Customer Code', datafield: 'Customer_Code', width: 110 },
                    { text: 'Customer Name', datafield: 'Customer_Name', width: 250 },
                    
                    { text: 'Order Date', datafield: 'Date_Commande', width: 110, cellsformat: 'yyyy-MM-dd' },
                    { text: 'Requested Date', datafield: 'Date_Demander', width: 110, cellsformat: 'yyyy-MM-dd' },
                    { text: 'Expedition Date', datafield: 'Date_Expedition', width: 110, cellsformat: 'yyyy-MM-dd' },
                    { text: 'Client PO', datafield: 'Po_Client', width: 150 },
                    //{ text: 'Buyer', datafield: 'Acheteur', width: 150 },
                    { text: 'Transmit', datafield: 'Transmit', width: 80 },
                    { text: 'Ready for Production', datafield: 'isReady_Production', width: 150, cellsrenderer: function(row, columnfield, value, defaulthtml, columnproperties) {
                        return value ? "<span style='color: green;'>Yes</span>" : "<span style='color: red;'>No</span>";
                    }},
                    { text: 'Lot ID', datafield: 'Lot_Id', width: 60 },
                    { text: 'Product ID', datafield: 'Product_Id', width: 80 },
                    { text: 'Product Number', datafield: 'PrNumber', width: 180 },
                    { text: 'Product Description', datafield: 'PrDescription1', width: 700 },
                    { text: 'Quantity', datafield: 'Lots_Qty', width: 100 },
