    ...
    $("#commandesGrid").jqxGrid({
     ...
     showtoolbar: true,
        ...
        columns: [
            ...
            { text: 'Order Code', datafield: 'InInvoiceNumber', width: '5%', align: 'center', cellsalign: 'center', editable: false },
            ...
            { text: 'Lot ID', datafield: 'Lot_Id', width: '4%', align: 'center', cellsalign: 'center', editable: false },
            { text: 'Product Number', datafield: 'PrNumber', width: '13%', align: 'center', editable: false },
            { text: 'Product Description', datafield: 'PrDescription1', width: '38%', align: 'center', editable: false },
            ...
            { text: 'Price', datafield: 'Lots_Price', width: '6%', cellsformat: 'c4', align: 'right', cellsalign: 'center', editable: false },
            { text: 'Unit', datafield: 'Unit_Price', width: '4%', align: 'center', cellsalign: 'center', editable: false },
